          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <form className="flex flex-1" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="relative w-full">
                ...
                <input
                  id="search-field"
                  className="block h-full max-w-xl:100rem  bg-white hover:bg-sky-200 transition-all duration-500 ease-in-out rounded-lg py-0 pl-8 pr-0 text-black focus:ring-0 sm:text-sm"
                  placeholder="Search..."
                  type="search"
                  name="search"
                  onChange={(e) => {
